<?php
// $Id: regcode.admin.php,v 1.1.4.7 2010/08/07 13:15:58 aidan Exp $
...
function regcode_admin_list() {
  return t('This page should be overriden by Views. If you are seeing this page, please check your Views configuration.');
}
...
function regcode_admin_create() {
  ...
  $params = array('!url' => url('admin/content/taxonomy/'.$vid.'/add/term'));
  ...
  $form['regcode_create_bulk']['regcode_create_format'] = array(
    ...
    '#options'       => array('alpha' => t('Letters'), 'numeric' => t('Numbers'), 'alphanum' => t('Numbers & Letters'), 'hexadec' => t('Hexadecimal')),
  );
