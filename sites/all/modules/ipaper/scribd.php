<?php
// $Id: scribd.php,v 1.1.2.11 2009/10/08 05:34:55 rares Exp $

/*
 * @file
 * Unofficial Scribd PHP Class library 
 * Downloaded from: http://www.scribd.com/platform/resources/libraries
 * With edits to request handling (now done by ipaper_request()), variable definitions, and support for xml parsing under php4.
 * Also added function getDownloadURL.
 */
   ...
   */
	...
	function postRequest($method, $params){
		...
		if (isset($post_params['file'])) {
		  ...
		  $xml = _ipaper_request($request_url, $post_params, "GET");
		}
