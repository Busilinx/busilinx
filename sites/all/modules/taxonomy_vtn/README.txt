$Id: README.txt,v 1.1.2.7 2009/11/27 11:07:02 alexiswilke Exp $
...
For a list of capabilities, you want to visit the project documentation and the
project page. It includes all the info you need to know about.

   http://www.m2osw.com/doc_taxonomy_vtn
