...
if (theme_get_setting('color_enable_schemes') == 'on') {
  drupal_add_css(drupal_get_path('theme', 'adaptive_gsl') .'/css/theme/'. get_at_colors(), 'theme');
}
 ...
 */
/*
function adaptive_gsl_preprocess(&$vars, $hook) {
 ...
 */
/*
function adaptive_gsl_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function adaptive_gsl_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function adaptive_gsl_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function adaptive_gsl_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/

function adaptive_gsl_content_view_multiple_field($items, $field, $values) {
  $output = '';
  $i = 0;
