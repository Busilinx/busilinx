...
<body class="<?php print $classes; ?>">
  <div id="container">
    ...
    <?php endif; ?>
      ...
      <div id="leaderboard">
      <div class="leaderboard-banner-left"><!--/* OpenX Javascript Tag v2.8.5-rc7 */-->
<script type='text/javascript'><!--//<![CDATA[
   var m3_u = (location.protocol=='https:'?'https://d1.openx.org/ajs.php':'http://d1.openx.org/ajs.php');
   var m3_r = Math.floor(Math.random()*99999999999);
   if (!document.MAX_used) document.MAX_used = ',';
   document.write ("<scr"+"ipt type='text/javascript' src='"+m3_u);
   document.write ("?zoneid=139356");
...
//]]>--></script><noscript><a href='http://d1.openx.org/ck.php?n=aa241683&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://d1.openx.org/avw.php?zoneid=139356&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=aa241683' border='0' alt='' /></a></noscript>
</div>
<div class="leaderboard-banner-right"><!--/* OpenX Javascript Tag v2.8.5-rc7 */-->
<script type='text/javascript'><!--//<![CDATA[
   var m3_u = (location.protocol=='https:'?'https://d1.openx.org/ajs.php':'http://d1.openx.org/ajs.php');
   var m3_r = Math.floor(Math.random()*99999999999);
   if (!document.MAX_used) document.MAX_used = ',';
   document.write ("<scr"+"ipt type='text/javascript' src='"+m3_u);
   document.write ("?zoneid=139357");
   document.write ('&amp;cb=' + m3_r);
   if (document.MAX_used != ',') document.write ("&amp;exclude=" + document.MAX_used);
   document.write (document.charset ? '&amp;charset='+document.charset : (document.characterSet ? '&amp;charset='+document.characterSet : ''));
   document.write ("&amp;loc=" + escape(window.location));
   ...
   if (document.mmm_fo) document.write ("&amp;mmm_fo=1");
   document.write ("'><\/scr"+"ipt>");
//]]>--></script><noscript><a href='http://d1.openx.org/ck.php?n=a078e10b&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://d1.openx.org/avw.php?zoneid=139357&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a078e10b' border='0' alt='' /></a></noscript>
</div>
<?php if ($leaderboard): print $leaderboard; endif; ?></div> <!-- /leaderboard -->
