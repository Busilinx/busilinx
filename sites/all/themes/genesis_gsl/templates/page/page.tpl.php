...
/**
 * @file page.tpl.php
 * Theme implementation to display a single Drupal page for the Genesis Lite theme.
 *
 * Available variables:
 *
...
<body id="genesis-1b" <?php print $section_class; ?>>
  <div id="container" class="<?php print $classes; ?>">
    ...
    <?php if ($leaderboard): ?>
      <div id="leaderboard" class="region section"><?php print $leaderboard; ?></div> <!-- /leaderboard -->
    <?php endif; ?>
    ...
    <?php if ($footer): ?>
      <div id="footer" class="section region"><?php print $footer; ?></div> <!-- /footer -->
    <?php endif; ?>

    <?php if ($footer_message or $feed_icons): ?>
      <div id="footer-message"><?php print $footer_message; ?><?php print $feed_icons; ?></div> <!-- /footer-message -->
    <?php endif; ?>
