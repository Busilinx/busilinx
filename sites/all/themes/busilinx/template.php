...
if (theme_get_setting('color_enable_schemes') == 'on') {
  drupal_add_css(drupal_get_path('theme', 'busilinx') .'/css/theme/'. get_at_colors(), 'theme');
}
 ...
 */
/*
function busilinx_preprocess(&$vars, $hook) {
 ...
 */
/*
function busilinx_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function busilinx_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function busilinx_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function busilinx_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/

function busilinx_content_view_multiple_field($items, $field, $values) {
  $output = '';
  $i = 0;
...
*/
function busilinx_username($object) {
