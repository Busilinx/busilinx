<?php /* Smarty version 2.6.26, created on 2011-06-06 18:55:58
         compiled from CRM/Activity/Form/Activity.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Activity/Form/Activity.tpl', 34, false),array('block', 'edit', 'CRM/Activity/Form/Activity.tpl', 163, false),array('function', 'crmURL', 'CRM/Activity/Form/Activity.tpl', 59, false),array('modifier', 'explode', 'CRM/Activity/Form/Activity.tpl', 60, false),array('modifier', 'escape', 'CRM/Activity/Form/Activity.tpl', 139, false),array('modifier', 'crmReplace', 'CRM/Activity/Form/Activity.tpl', 178, false),array('modifier', 'crmDate', 'CRM/Activity/Form/Activity.tpl', 201, false),array('modifier', 'crmStripAlternatives', 'CRM/Activity/Form/Activity.tpl', 224, false),)), $this); ?>
             ...
             <tr class="crm-activity-form-block-details">
               <td class="label"><?php echo $this->_tpl_vars['form']['details']['label']; ?>
        	        ...
        	        <?php if ($this->_tpl_vars['activityTypeName'] == 'Print PDF Letter'): ?>
            		  <td class="view-value">
                                                    <?php if ($this->_tpl_vars['defaultWysiwygEditor'] == 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['details']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'huge') : smarty_modifier_crmReplace($_tmp, 'class', 'huge')); ?>
<?php else: ?><?php echo $this->_tpl_vars['form']['details']['html']; ?>
<?php endif; ?>
            		  </td>
            		<?php else: ?>
            	      <td class="view-value">
                                                    <?php if ($this->_tpl_vars['defaultWysiwygEditor'] == 0): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['form']['details']['html'])) ? $this->_run_mod_handler('crmStripAlternatives', true, $_tmp) : smarty_modifier_crmStripAlternatives($_tmp)))) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'huge') : smarty_modifier_crmReplace($_tmp, 'class', 'huge')); ?>
...
&nbsp;<?php echo $this->_tpl_vars['form']['interval_unit']['html']; ?>
                           ...
                           <tr>
                              ...
                              <td><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['followup_activity_subject']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'huge') : smarty_modifier_crmReplace($_tmp, 'class', 'huge')); ?>
</td>
                           </tr>
                        </table>
