<?php /* Smarty version 2.6.26, created on 2011-08-11 16:23:44
...
">
            ...
            <td><a href="<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view','q' => "reset=1&cid=".($this->_tpl_vars['row']['contact_id'])."&key=".($this->_tpl_vars['qfKey'])), $this);?>
...
"<?php endif; ?>>
                        ...
                        <?php if ($this->_tpl_vars['row']['on_hold']): ?>&nbsp;(On Hold)<?php endif; ?>
                    </span>
                <?php endif; ?>
              </td>
              <td>
                <?php if ($this->_tpl_vars['row']['phone']): ?>
                    <span<?php if ($this->_tpl_vars['row']['do_not_phone']): ?> class="do-not-phone" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Do Not Phone<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" <?php endif; ?>><?php echo $this->_tpl_vars['row']['phone']; ?>
</span>
                <?php endif; ?>
              </td>
           <?php else: ?>
